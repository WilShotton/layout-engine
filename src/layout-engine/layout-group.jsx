                ...
                this.event('resizeContent')
                    ...
                    .withLatestFrom(
                        ...
                        ({index, x, y}, {width, height}) => ({snapshot, values}) => {
                            ...
                            // NOTE: The following fixes an offset that occurs when resizing at speed
                            const total = _.reduce(update, (acc, {measure}) => acc + measure, 0)

                            if (total > height) {

                                const last = _.find(update, ({measure}) => measure > MIN_MEASURE)

                                if (last) {
                                    last.measure -= total - height
                                }
                            }
